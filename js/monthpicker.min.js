        ...
        function add(element) {
            ...
            if (tpl.type == "dropdown") {
                ...
                for (var i = 0; i < range.length; i++) {
                    ...
                    jQuery('<li class="li"></li>').append(jQuery('<a href="javascript:;" class="' + className + '" ' + 'id="' + range[i] + '">' + text[i] + '</a>').click(function () {
                ...
                for (var i = 0; i < range.length; i++) {
					//alert(range.length);
                    className = (tpl.value == range[i]) ? "selected" : "";
                    jQuery('<a href="javascript:;" id="' + range[i] + '" ' +  'class="suppress"><span class="' + className + '">' + text[i] + '</span></a>').click(function () {
                        var $this = jQuery(this);
                        var value = $this.attr('id');
